...
{
    public const decimal BaseRewardInitial = 9m;
	public const ulong oneHeight = 200000;
	public const decimal oneHeightReward = 8.55m;
	public const ulong twoHeight = 400000;
	public const decimal twoHeightReward = 8.1225m;
	public const ulong threeHeight = 600000;
	public const decimal threeHeightReward = 7.7164m;
	public const ulong fourHeight = 800000;
	public const decimal fourHeightReward = 7.3306m;
	public const ulong fiveHeight = 1000000;
	public const decimal fiveHeightReward = 6.9640m;
}

public class DubxConstants
{
    public const decimal BaseRewardInitial = 2.0m;
}
